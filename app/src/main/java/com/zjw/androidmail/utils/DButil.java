...
public class DButil extends SQLiteOpenHelper{
    ...
    public DButil(Context context){
        super(context, "mailconstants.db", null, 1);
    }

    @Override
    public void onCreate(SQLiteDatabase db){
        db.execSQL("create table mail(id INTEGER PRIMARY KEY AUTOINCREMENT, mailfrom varchar(20), name varchar(20), address varchar(20))");
        ...
        db.execSQL("create table mailstatus(id INTEGER PRIMARY KEY AUTOINCREMENT, mailfrom varchar(20), messageid varchar(100))");
    }
